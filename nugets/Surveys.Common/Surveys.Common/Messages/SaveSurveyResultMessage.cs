namespace Surveys.Common.Messages
{
    ...
    /// </summary>
    public class SaveSurveyResultMessage : ISaveSurveyResultMessage
    {
        /// <summary>
        ...
        public SaveSurveyResultMessage(
        ...
        /// </summary>
        [JsonProperty("isSuggested", Required = Required.Always, Order = 3)]
        ...
        /// </summary>
        [JsonProperty("results", Required = Required.Always, Order = 4)]
